<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="MapWrapper.Default" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>BasicCensusMap</title>
    <style type="text/css">
    html, body {
	    height: 100%;
	    overflow: auto;
    ...
    <script type="text/javascript">
        ...
        var _gaq = _gaq || [];
        _gaq.push(['_setAccount', 'UA-8063472-3']);
...
<body>
    ...
    <div>
    <h1>2010 US Census Map</h1>
    </div>
    <div id="silverlightControlHost">
        <object data="data:application/x-silverlight-2," type="application/x-silverlight-2" width="100%" height="100%">
		  <param name="source" value="ClientBin/BasicCensusMap.xap"/>
